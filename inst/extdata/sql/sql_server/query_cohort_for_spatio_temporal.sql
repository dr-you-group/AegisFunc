...
SELECT DISTINCT
  ...
  c.cohort_start_date,
  c.cohort_end_date,
  YEAR(c.cohort_start_date) AS cohort_start_year,
  p.location_id,
  CASE
...
(
  ...
  GROUP BY location_id, latitude, longitude, cohort_start_year, age_category, sex_category
) o
ON
...
AND
  t.cohort_start_year = o.cohort_start_year
AND
  t.age_category = o.age_category
AND
  t.sex_category = o.sex_category
ORDER BY t.location_id, t.cohort_start_year, t.age_category, t.sex_category
;